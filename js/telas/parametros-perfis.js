...
async function parametrosPerfisInit() {
    ...
    c.innerHTML = `
        ...
        <div class="rounded-2xl border-2 overflow-hidden mb-4" style="border-color:var(--line);background:#fff">
